  ...
  var Locale = /*#__PURE__*/ (function () {
    ...
    _proto4.months = function months$1(length, format) {
      ...
      return listStuff(this, length, months, function () {
        ...
        var monthSpecialCase =
          _this2.intl === "ja" || _this2.intl.startsWith("ja-");
        ...
        tokenToString = function tokenToString(lildur, info) {
          return function (token) {
            ...
            if (mapped) {
              ...
              var signDisplay;
              if (
                _this2.opts.signMode === "negativeLargestOnly" &&
  ...
  var DateTime = /*#__PURE__*/ (function (_Symbol$for) {
    ...
    _proto.toISO = function toISO(_temp4) {
      var _ref5 = _temp4 === void 0 ? {} : _temp4,
        ...
        precision =
          _ref5$precision === void 0 ? "milliseconds" : _ref5$precision;
      if (!this.isValid) {
        return null;
      }
    ...
    _proto.toISOTime = function toISOTime(_temp6) {
      var _ref7 = _temp6 === void 0 ? {} : _temp6,
        ...
        precision =
          _ref7$precision === void 0 ? "milliseconds" : _ref7$precision;
      if (!this.isValid) {
        return null;
      }
      precision = normalizeUnit(precision);
